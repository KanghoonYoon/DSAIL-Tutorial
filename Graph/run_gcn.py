...
from src.nn.GCN import GraphConvolutionalLayer
...
class GCNClassifier(nn.Module):
    ...
    def __init__(self, input_dim, h_dim, out_dim):
        ...
        self.gcn_layer1 = GraphConvolutionalLayer(h_dim, h_dim)
        self.gcn_layer2 = GraphConvolutionalLayer(h_dim, h_dim)
    ...
    def forward(self, g, x):
        ...
        h = nn.ReLU()(self.gcn_layer1(g, h))
        h = nn.ReLU()(self.gcn_layer2(g, h))
...
if __name__ == "__main__":
    ...
    model = GCNClassifier(input_dim=X.size(1), h_dim=config.h_dim, out_dim=dataset.num_classes)
